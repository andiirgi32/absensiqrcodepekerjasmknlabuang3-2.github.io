...
<body id="page-top">
  ...
  <div id="wrapper">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-striped table-hover" id="dataTable">
                    ...
                    <tbody>
                      <?php
                      $sql = mysqli_query($conn, "SELECT pekerja.*, pangkat.*, jabatan.*, golongan.* 
    FROM pekerja 
    ...
    WHERE pekerja.jabatanid=jabatan.jabatanid 
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
      <form class="modal-content" action="proses_pekerja.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <input type="file" name="fotopekerja" id="inputFotoUser" class="form-control" hidden required>
          <script>
          ...
          <input type="text" class="form-control mb-2" id="nip" name="nip" placeholder="klik dan ketik disini..." required>
          <p class="text-danger">
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <form class="modal-content" action="update_pekerja.php" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <input type="text" class="form-control mb-2" id="nip<?= $index ?>" name="nip" placeholder="klik dan ketik disini..." value="<?= $data['nip'] ?>" required>
            <p class="text-danger">
              Jika pekerja belum punya NIP, maka bisa menggunakan Nama atau yang lain
            </p>
            <script>
