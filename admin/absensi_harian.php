        ...
        <li class="nav-item">
          ...
          <div id="collapseTableAbsensiPelajar" class="collapse show" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="card py-2 collapse-inner rounded">
              ...
              <a class="collapse-item btn-light active" style="border: 0px;" href="absensi_harian.php">
                Absensi Harian
              </a>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-6" style="margin-left: -20px;">
                                    ...
                                    ?>
                                      ...
                                      ?> -->
                                      <?php
                                      if ($data["keterangandatang"] == "Hadir") {
                                      ?>
                                        <b class="text-success"><?= $data['keterangandatang'] ?></b>
                                      <?php
                                      } else {
                                      ...
                                      <!-- ) -->
                                    <?php
                                    } else if ($data["keterangantakabsen"] != "") {
                                    ?>
                                      <div class="<?= $ket_tak_absen ?>">
                                        <?php echo $data['keterangantakabsen']; ?>
                                      </div>
                                    <?php
                                    } else {
                                    ?>
                                  ...
                                  ?>
                                    <div class="col-4" style="padding: 0; margin: 0; margin-left: -10px;">
                                      <img src="fotobuktidatang/<?= $data['fotodatang'] ?>" alt="" style="width: 100%;">
                                    </div>
                                  <?php
                                  }
                                  ?>
                              ...
                              <li class="list-group-item">
                                <div class="row">
                                  ...
                                  ?>
                                    <div class="col-4" style="padding: 0; margin: 0; margin-left: -10px;">
                                      <img src="fotobuktipulang/<?= $data['fotopulang'] ?>" alt="" style="width: 100%;">
                                    </div>
                                  <?php
                                  }
                                  ?>
